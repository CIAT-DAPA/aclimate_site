  ...
  return (
    <div className="container-page" style={{ scrollSnapType: "y mandatory" }}>
      ...
      <section>
        <p className="font-link-body text-center p-subtitle">
          Quisque id mi quam. Donec interdum sapien elit, eu faucibus orci
          viverra et. Quisque sed tortor nec nibh consequat molestie. Donec non
          sapien eu elit cursus varius id quis tellus. Integer semper ex sit
          amet lacus sagittis accumsan. Nulla sollicitudin commodo consequat.
          Nam semper suscipit urna id ornare. Duis tristique commodo nulla, at
          feugiat nunc placerat at. Aenean vestibulum eros et dui suscipit, sit
          amet ultrices erat eleifend. Pellentesque eget sapien eget justo
          accumsan scelerisque ut id diam.
        </p>
      </section>
    </div>
  );
